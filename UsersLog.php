...
<section class="container py-lg-5">
  <!--User table-->
    <h1 class="slideInDown animated">Riwayat Presensi</h1>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filter Riwayat User:</h3>
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      ...
                      <label for="Start-Date"><b>Tanggal Mulai:</b></label>
                      <input type="date" name="date_sel_start" id="date_sel_start">
                      <label for="End -Date"><b>Tanggal Selesai:</b></label>
                    ...
                    <div class="panel panel-primary">
                      <div class="panel-heading">
                        ...
                        <div class="time">
                          ...
                          <label for="radio-one">Waktu Datang</label>
                          <input type="radio" id="radio-two" name="time_sel" class="time_sel" value="Time_out" />
                          <label for="radio-two">Waktu Pulang</label>
                        </div>
                      </div>
                      <div class="panel-body">
                        <label for="Start-Time"><b>Waktu Awal:</b></label>
                        <input type="time" name="time_sel_start" id="time_sel_start">
                        <label for="End -Time"><b>Waktu Selesai:</b></label>
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Filter Berdasarkan User:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Filter Berdasarkan Divisi:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Ekspor ke Excel:</b></label>
